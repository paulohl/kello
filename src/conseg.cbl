      ...
      *    COPY "DSSYSINF.CPY".
       ...
       INICIALIZA-PROGRAMA SECTION.
           ...
           MOVE "CADSEG"  TO ARQ-REC. MOVE EMPRESA-REF TO PATH-CADSEG.
           OPEN INPUT CADSEG
           IF ST-CADSEG <> "00"
              MOVE "ERRO ABERTURA CADSEG: "  TO GS-MENSAGEM-ERRO
              MOVE ST-CADSEG TO GS-MENSAGEM-ERRO(23: 02)
       ...
       CARREGA-ULTIMOS SECTION.
           ...
           PERFORM UNTIL ST-CADSEG = "10"
              ...
              NOT AT END
                ADD 1                  TO GS-CONT
                MOVE CADSEG-NOME       TO GS-LINDET(1: 30)
                MOVE CADSEG-CODIGO     TO GS-LINDET(33: 4)
